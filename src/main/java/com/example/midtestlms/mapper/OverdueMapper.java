...
public interface OverdueMapper {
    ...
    @Select("select a.r_id, a.b_id, b.isbn, b.b_title, b.c_id, b.b_author, b.b_publisher, (a.cnt_date - (14 + (a.ext_num * 7))) as cnt_date \n" +
            ...
            "join lms.book_info b on a.isbn = b.isbn where a.cnt_date - (14 + (a.ext_num * 7)) > 0 and a.m_id = #{member.m_id}\n")
    List<Overdue> findCntDate(@Param("member") final Member member);
